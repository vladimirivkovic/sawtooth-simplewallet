...
# ------------------------------------------------------------------------------
'''
This file is used for automated testing of the marbles client.
'''

from sawtooth_processor_test.message_factory import MessageFactory

class MarblesMessageFactory(object):
    def __init__(self, signer=None):
        self._factory = MessageFactory(
            family_name="marbles",
            family_version="1.0",
            namespace=MessageFactory.sha512("marbles".encode("utf-8"))[0:6],
            signer=signer)
