...
# ------------------------------------------------------------------------------
'''
This MarblesClient class interfaces with Sawtooth through the REST API.
'''
...
class MarblesClient(object):
    '''Client marbles class.

    This supports init, read, transfer, and delete functions.
    '''
    ...
    def delete(self, name):
        try:
            ...
            raise Exception('Encountered an error during deletion')
        return retValue
